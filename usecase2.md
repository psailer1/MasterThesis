...
![SequenceDiagramm Use Case 2](/images/Usecase2and4sequence.png)
...
To measure Use Case 2, the workload must first be defined and executed. The workload controller connects to C2 and send a request to the orchestration system, as shown in the first figure. The rest of the process can be found in the section [Architecture](#architecture). 
...
![pom.xml File Use Case 2](/images/mavenuc2.png)
