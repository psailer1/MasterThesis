...
In this file the Use Case 3 is described. Use Case 3 is implemented with the procedure of Scenario 1 and is considered for the local execution on one device. It used the protocol HTTP, which means no secure communication is provided.
...
![pom.xml File Use Case 3](/images/mavenuc3.png)
